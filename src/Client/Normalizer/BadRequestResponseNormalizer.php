...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BadRequestResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Combell\Client\Model\BadRequestResponse::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Combell\Client\Model\BadRequestResponse::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('validation_errors', $data)) {
                ...
                foreach ($data['validation_errors'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Combell\Client\Model\ValidationErrorMessage::class, 'json', $context);
                }
        ...
        {
            return [\Combell\Client\Model\BadRequestResponse::class => false];
        }
    }
} else {
    class BadRequestResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
