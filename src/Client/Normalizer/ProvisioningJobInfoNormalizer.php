...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProvisioningJobInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Combell\Client\Model\ProvisioningJobInfo::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Combell\Client\Model\ProvisioningJobInfo::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('completion', $data)) {
                $object->setCompletion($this->denormalizer->denormalize($data['completion'], \Combell\Client\Model\CompletionEstimation::class, 'json', $context));
            }
            return $object;
        }
        ...
        {
            return [\Combell\Client\Model\ProvisioningJobInfo::class => false];
        }
    }
} else {
    class ProvisioningJobInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
