...
class Client extends \Combell\Client\Runtime\Client\Client
{
     ...
     */
    public function getRecords(string $domainName, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\GetRecords($domainName, $queryParameters), $fetch);
    }
    /**
     * 
     *
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function createRecord(string $domainName, ?\Combell\Client\Model\DnsRecord $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\CreateRecord($domainName, $requestBody), $fetch);
    }
    /**
     * 
     *
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function deleteRecord(string $domainName, string $recordId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\DeleteRecord($domainName, $recordId), $fetch);
    }
    /**
     * 
     *
     ...
     * @return null|\Combell\Client\Model\DnsRecord|\Psr\Http\Message\ResponseInterface
     */
    public function getRecord(string $domainName, string $recordId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\GetRecord($domainName, $recordId), $fetch);
    }
    /**
     * 
     *
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function editRecord(string $domainName, string $recordId, ?\Combell\Client\Model\DnsRecord $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\EditRecord($domainName, $recordId, $requestBody), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function getDomains(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\GetDomains($queryParameters), $fetch);
    }
    /**
     * 
     *
     ...
     */
    public function getDomain(string $domainName, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\GetDomain($domainName), $fetch);
    }
    /**
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function register(?\Combell\Client\Model\RegisterDomain $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\Register($requestBody), $fetch);
    }
    /**
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function transfer(?\Combell\Client\Model\TransferDomain $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\Transfer($requestBody), $fetch);
    }
    /**
     * 
     *
     ...
     * @return null|\Psr\Http\Message\ResponseInterface
     */
    public function editNameServers(string $domainName, ?\Combell\Client\Model\EditNameServers $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\EditNameServers($domainName, $requestBody), $fetch);
    }
    /**
    ...
    */
     ...
     */
    public function getLinuxHostings(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     */
    public function getMailboxes(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
     ...
     */
    public function getMySqlDatabases(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
    public function getProvisioningJob(string $jobId, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Combell\Client\Endpoint\GetProvisioningJob($jobId), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     ...
     */
    public function getAllSshKeys(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
     ...
     */
    public function getSslCertificateRequests(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    */
     ...
     */
    public function getSslCertificates(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    * @return null|\Psr\Http\Message\ResponseInterface
    */
    public function downloadCertificate(string $sha1Fingerprint, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
     ...
     */
    public function getWindowsHostings(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
    ...
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        if (null === $httpClient) {
            ...
            $plugins = [];
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUriFactory()->createUri('/v2');
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Combell\Client\Normalizer\JaneObjectNormalizer()];
